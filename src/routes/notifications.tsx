            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  ...
                  {n.type === "trusted-host" && (
                    <>
                      <Button size="sm" onClick={() => toast.success("Trusted")}>
                        Approve
                      </Button>
                      <Button size="sm" variant="outline" onClick={() => toast.success("Declined")}>
                        Decline
                      </Button>
                    </>
                  )}
                  {n.type === "guest-match" && (
                    <Button size="sm" variant="outline">
                      Connect guest <ChevronRight className="h-3.5 w-3.5" />
                    </Button>
                  )}
                </div>
              </div>
