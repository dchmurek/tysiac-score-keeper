    ...
    <AppShell>
      <div className="mx-auto max-w-3xl px-4 py-6 sm:px-6 sm:py-10">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Manage your profile, privacy and trusted hosts.
        </p>
        ...
        <div className="mt-6 space-y-4">
          ...
          <Section
            title="Trusted hosts"
            description="Trusted hosts can add you to matches without manual confirmation."
          >
              ...
              {trustedHosts.map((h) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <Badge variant={h.status === "active" ? "secondary" : "outline"}>
                      {h.status}
                    </Badge>
          ...
          <Section title="Privacy">
            <div className="space-y-3">
              {[
                ...
                {
                  label: "Allow trusted hosts to add me to games",
                  val: allowAdds,
                  set: setAllowAdds,
                },
              ].map((row) => (
