  ...
  rounds: [
    {
      ...
      scoreAfterB: 50,
      enteredBy: "Adam",
      timestamp: "2026-06-08T19:08:00Z",
    },
    {
      id: "rnd-2",
      number: 2,
      ...
      scoreAfterB: 170,
      enteredBy: "Adam",
      timestamp: "2026-06-08T19:18:00Z",
    },
    {
      id: "rnd-3",
      number: 3,
      ...
      scoreAfterB: 210,
      enteredBy: "Adam",
      timestamp: "2026-06-08T19:31:00Z",
      note: "Strong hand.",
    },
    {
      id: "rnd-4",
      ...
      scoreAfterB: 350,
      enteredBy: "Adam",
      timestamp: "2026-06-08T19:44:00Z",
    },
    {
      id: "rnd-5",
      number: 5,
      ...
      scoreAfterB: 400,
      enteredBy: "Adam",
      timestamp: "2026-06-08T19:58:00Z",
    },
    {
      id: "rnd-6",
      number: 6,
      ...
      scoreAfterB: 480,
      enteredBy: "Adam",
      timestamp: "2026-06-08T20:12:00Z",
    },
    {
      id: "rnd-7",
      number: 7,
    ...
    },
    {
      ...
      scoreAfterB: 720,
      enteredBy: "Adam",
      timestamp: "2026-06-08T20:39:00Z",
    },
  ],
};
...
export const recentMatches: Match[] = [
  {
    id: "m-1",
    date: "2026-06-01",
    roomName: "Sunday Evening",
    teamA: { players: ["Adam", "Kuba"], score: 1000 },
    teamB: { players: ["Bartek", "Michał"], score: 870 },
    winner: "A",
    rounds: 11,
    durationMinutes: 62,
    status: "finished",
  },
  {
    ...
    date: "2026-05-28",
    roomName: "Quick Game",
    teamA: { players: ["Adam", "Bartek"], score: 760 },
    teamB: { players: ["Kuba", "Michał"], score: 1000 },
    winner: "B",
    rounds: 9,
    durationMinutes: 48,
    status: "finished",
  },
  {
    ...
    date: "2026-05-22",
    roomName: "Marathon",
    teamA: { players: ["Adam", "Michał"], score: 1000 },
    teamB: { players: ["Kuba", "Bartek"], score: 920 },
    winner: "A",
    rounds: 14,
    durationMinutes: 85,
    status: "finished",
  },
  {
    ...
    teamA: { players: ["Adam", "Ola"], score: 820 },
    teamB: { players: ["Piotr", "Michał"], score: 1000 },
    winner: "B",
    rounds: 10,
    durationMinutes: 55,
    status: "finished",
  },
  {
    id: "m-5",
    date: "2026-05-09",
    roomName: "Saturday Match",
    teamA: { players: ["Adam", "Kuba"], score: 1000 },
    teamB: { players: ["Bartek", "Piotr"], score: 740 },
    winner: "A",
    rounds: 12,
    durationMinutes: 70,
    status: "finished",
...
export const pendingConfirmations: PendingConfirmation[] = [
  {
    ...
    hostName: "Adam",
    date: "2026-05-22",
    message: "Adam added you to a match on May 22, 2026",
  },
  {
    id: "pc-2",
    matchId: "m-98",
    hostName: "Bartek",
    date: "2026-05-18",
    message: "Bartek added you to a match on May 18, 2026",
  },
];
...
export const notifications: NotificationItem[] = [
  {
    id: "n-1",
    type: "confirmation",
    message: "Adam added you to a match.",
  ...
  },
  {
    id: "n-2",
    type: "trusted-host",
    message: "Bartek wants to allow you to add him to matches automatically.",
  ...
  },
  {
    id: "n-3",
    type: "guest-match",
    message: "A guest match can be connected to your account.",
  ...
  },
  {
    id: "n-4",
    type: "accepted",
    message: "Michał accepted your match invitation.",
    timestamp: "2026-06-04T22:30:00Z",
    read: true,
  },
  {
    id: "n-5",
    type: "rejected",
    message: "Ola declined a match participation.",
